              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: FutureBuilder<List<ComentarioModel>>(
                      future: _reporteService.obtenerComentarios(reporte.id),
                      builder: (context, snapshot) {
                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return ListTile(
                              ...
                              subtitle: Text(
                                '${com.fecha.day}/${com.fecha.month}/${com.fecha.year}',
                  ...
                  child: Row(
                    children: [
                      ...
                      FilterChip(
                        ...
                        onSelected: (_) =>
                            setState(() => filtroEstadoLocal = 'pendientes'),
                      ),
                      const SizedBox(width: 8),
                      FilterChip(
                        ...
                        onSelected: (_) =>
                            setState(() => filtroEstadoLocal = 'resueltos'),
                      ),
                      const SizedBox(width: 8),
                      FilterChip(
                        ...
                        onSelected: (_) =>
                            setState(() => filtroEstadoLocal = 'falsos'),
                      ),
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return Card(
                            ...
                            shape: RoundedRectangleBorder(
                              side: BorderSide(
                                color: reporte.getColorSeveridad().withOpacity(
                                  0.5,
                                ),
                                width: 1,
                              ),
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      const SizedBox(width: 4),
                                      Text(
                                        '${reporte.contadorCorroboraciones} Apoyos',
                                        style: TextStyle(
